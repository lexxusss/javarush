...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        if (param.equals(Planet.EARTH)) thePlanet = Earth.getInstance();
        if (param.equals(Planet.MOON)) thePlanet = Moon.getInstance();
        if (param.equals(Planet.SUN)) thePlanet = Sun.getInstance();
    }
}
