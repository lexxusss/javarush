...
public class Solution {
    ...
    public abstract static class Book {
        ...
        private String getOutputByBookType() {
            String agathaChristieOutput = this.author + ", " + this.getBook().getName() + " is a detective";
            String markTwainOutput = this.getBook().getName() + " book was written by " + this.author;
