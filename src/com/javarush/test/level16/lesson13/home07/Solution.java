...
Каждый игрок(Gamer) характеризуется двумя параметрами: фамилией(name) и количеством действий в секунду (rating).
...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            ...
            for (int i = 0; !OnlineGame.isWinnerFound && i < size; i++) {
